...
# THIS WAS A TEST TO VERIFY IF THE MEDIA BROWSER WILL ACCEPT MULTIPLE FILES IN AN UPLOAD REQUEST
# IT DOES NOT

# Usage: $0 <doorbell-snapshot.jpg> <data.json>
...
#MEDIA_FILE=$1
DATA_FILE="doorbell_metadata.json"
#DATA_FILE=$2
...
curl -v -H "Authorization: Bearer ${HA_ACCESS_TOKEN}" \
